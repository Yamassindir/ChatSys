 ...
 */
public class ReceiveMessage11 implements Runnable {
...
//                        }
                        ...
                        for (int j = 0; j < ChatList.getListUsers().size(); j++) {
                            if (ChatList.getKeyByValue(ChatList.getMapUsers(), dp.getAddress()) == ChatList.getListUsers().get(j)) {
                                ChatList.getJListUsernames().remove(j);
                            }
                        }
                        DefaultListModel dlm = new DefaultListModel();
